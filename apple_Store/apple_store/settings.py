...
SECRET_KEY = 'django-insecure-9j#qn_#qv$s(c=4d5=jl7ka(t@jo@g$5&@jr=l5pt-ll90#l0l'
...
MEDIA_ROOT = BASE_DIR / 'media'  # La ubicación en el sistema de archivos donde se guardarán
LOGIN_REDIRECT_URL = '/ver-pedidos/'
